...
# target
参数说明，用于指定编译后所兼容的js版本
可选值'ES3', 'ES5', 'ES2015', 'ES2016'(default), 'ES2017', 'ES2018', 'ES2019' or 'ESNEXT'

es6/es2015
es6注定会成为ECMAScript的经典版本，因为es6做了很多的升级，

> 从2015年开始，ECMAScript每隔一年发布一个版本，因此使用年份作为版本号
